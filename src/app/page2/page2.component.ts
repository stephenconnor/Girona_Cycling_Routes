...
export class Page2Component implements OnInit {
  ...
  longRoutes = [
    ...
    {title:"Banyoles Hills", description:"Loop from Girona to Banyoles, with a samll hilly loop to finish"+`<a role="link" Title="Garmin Connect" target="_blank" href="https://connect.garmin.com/modern/course/139627380"><p>Banyoles Hills &nbsp;&nbsp;<i class="bi bi-geo-alt"></i></p><img src="assets/images/Banyoles Hills.jpg"></a>`},
  ]
