...
export class Page1Component implements OnInit {
  ...
  shortRoutes = [
    ...
    {title:"Llora Constantin St Gregori", description:"Llora Constantin St Gregori recovery loop. (Gravel sectors)"+`<a role="link" Title="Garmin Connect" target="_blank" href="https://connect.garmin.com/modern/course/148385620"><p>Llora Constantin St Gregori &nbsp;&nbsp;<i class="bi bi-geo-alt"></i></p><img src="assets/images/Llora_Constantin_St_Gregori.jpg"></a>`},
    // Longer routes
  ]
